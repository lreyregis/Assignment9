...
import com.example.doglist.LandingScreenActivity
import com.example.doglist.R
import com.example.doglist.databinding.FragmentEmailpasswordBinding
...
class EmailPasswordFragment : BaseFragment() {
    ...
    private fun checkForMultiFactorFailure(e: Exception) {
        ...
        if (e is FirebaseAuthMultiFactorException) {
            ...
            findNavController().navigate(R.id.action_emailPasswordFragment_to_multiFactorFragment, args)
        }
    }
